...
- `_material-defaults.scss`. In Sakai 20.x, the option to enable several design elements from Google's material design library were introduced. This file contains several boolean variables that enable the various functionality.
