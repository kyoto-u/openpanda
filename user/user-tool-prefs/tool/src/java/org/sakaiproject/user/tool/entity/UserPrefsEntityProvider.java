/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/user/branches/sakai-2.8.x/user-tool-prefs/tool/src/java/org/sakaiproject/user/tool/entity/UserPrefsEntityProvider.java $
