/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/kernel/tags/sakai-10.6/kernel-impl/src/main/java/org/sakaiproject/memory/impl/BasicMemoryService.java $
...
//		}
	...
	private Ehcache instantiateCache(String cacheName)
	{
		...
		if (cache != null && cache.getStatus().equals(Status.STATUS_ALIVE)) {
			...
			cache.setStatisticsEnabled(!(serverConfigurationService().getBoolean("memory.cache.statistics.force.disabled", false)));
		}
